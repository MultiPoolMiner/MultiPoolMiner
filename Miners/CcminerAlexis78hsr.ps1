...
$Commands = [PSCustomObject]@{
    "_blake2s"   = "" # my best values Values for 1080ti/1070/10603G "-i 31,31,31" #Blake2s, Beaten by Ccminer-x11gost. Note: do not use Excavator, high rejects
    "blakecoin"  = "" #Blakecoin, fastest!
    "_c11"        = "" # my best values Values for 1080ti/1070/10603G "-i 21.5,21.5,21" #C11 beaten by Ccminer-x11gost
    "_decred"    = "" #Decred, broken, invalid share
    "_hsr"        = "" # my best values Values for 1080ti/1070/10603G "-i 21.5,21.5,21" # hsr, beaten by CcminerPalginHSR!
    "_keccak"    = "" # my best values Values for 1080ti/1070/10603G "-m 2 -i 20" #Keccak beaten by CcminerXevan
    "_lbry"      = "" # my best values Values for 1080ti/1070/10603G "-i 28" #Lbry beaten by ExcavatorNvidia6
    ...
    "_sia"       = "" #Sia
    "_sib"        = "" # my best values Values for 1080ti/1070/10603G "-i 21.5,20.5,20.5" #Sib / x11gost, beaten by Ccminer-x11gost
    "_skein"      = "" # my best values Values for 1080ti/1070/10603G "-i 30,20,28.9" #Skein, where do my hashes go???
    ...
    "_x17"        = "" # my best values Values for 1080ti/1070/10603G "-i 21.,21.5,20.9" # Fastest
}
