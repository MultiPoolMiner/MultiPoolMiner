...
$Path = ".\Bin\NVIDIA-Ccminer-2.2-mod-r2\ccminer.exe"
$Uri = "http://cryptomining-blog.com/wp-content/download/ccminer-2.2-mod-r2.zip"
...
$Commands = [PSCustomObject]@{
    ...
    "_lbry"        = ""
    "_lyra2v2"     = " -i 24.25,23.75,24.25" # beaten by Ccminer-Palgin-Nist5
    ...
    "_skunk"       = " -i 25.7,25.2,25,2" # Beaten by Ccminer-2.2.3
    "_tribus"      = ""
    "_vanilla"     = ""
