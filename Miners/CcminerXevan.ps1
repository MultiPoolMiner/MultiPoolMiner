...
$Commands = [PSCustomObject]@{
    ...
    "_blakecoin" = "" # my best values for 1080ti/1070/10603G " -i 31" # beaten by CcminerSp-mod
    "_c11"       = "" # my best values for 1080ti/1070/10603G " -i 21" # Stratum problem on mine.zpool.ca
    "_decred"    = "" #broken, gives invalid share
    "_keccak"    = "" # my best values for 1080ti/1070/10603G " -i 31,28,28 -m 2" # beaten by Ccminer-2.2.3
    "_lbry"      = "" # Beaten by ExcavatorNvidia5
    "_lyra2v2"   = "" # my best values for 1080ti/1070/10603G " -i 24" # Beaten by Excavator132Nvidia6
    "_myr-gr"    = "" # my best values for 1080ti/1070/10603G " -i 24" # No results on mine.zpool.ca
    "_neoscrypt" = "" # my best values for 1080ti/1070/10603G " -i 22" # slow. beaten by Ccminer Nanashi
    ...
    "sia"        = ""  
    "_sib"       = "" # my best values for 1080ti/1070/10603G " -i 21" # sib is broken 
    "_skein"     = "" # my best values for 1080ti/1070/10603G " -i 30" # Beaten by CcminerPalgin-Nist5 
    "_veltor"    = "" # my best values for 1080ti/1070/10603G " -i 22" # Broken
    "_x11"       = "" # my best values for 1080ti/1070/10603G " -i 21" 
    "_x11evo"    = "" # my best values for 1080ti/1070/10603G " -i 21" 
    "_x13"       = "" 
    "_x14"       = "" # my best values for 1080ti/1070/10603G " -i 21" 
    "_x15"       = "" # my best values for 1080ti/1070/10603G " -i 20" 
    "xevan"      = "" # my best values for 1080ti/1070/10603G " -i 21.5,20,18"
}
