...
#    "blake2s"      = "" # my best values Values for 1080ti/1070/10603G "-i 31" # beaten by Excavator136aNvidia4
...
#    "cryptonight"  = "" # my best values Values for 1080ti/1070/10603G "-i 10.25,10.25,10.25 --bfactor=12"
#    "decred"       = ""
#    "equihash"     = ""
#    "groestl"      = "" # my best values Values for 1080ti/1070/10603G "-i 26.5" # beaten by Ccminer-Klaust814_CUDA9
#    "hmq1725"      = ""
#    "hsr"          = "" # my best values Values for 1080ti/1070/10603G "-i 21" # beaten by CcminerAlexis78hsr
...
#    "nist5"        = "" # my best values Values for 1080ti/1070/10603G "-i 22" # Beaten, beaten by Ccminer-Palgin-Nist5
#	"penta"         = "" # Pentablake hash (5x Blake 512)
#    "phi"          = "" # my best values Values for 1080ti/1070/10603G "-i 25,24,24"
	"poly"          = "" # my best values Values for 1080ti/1070/10603G "-i 25.5,24.5,24.5" # polytimos
#    "quark"        = "" 
#    "qubit"        = ""
#    "scrypt"       = "" 
#    "sia"          = "" # my best values Values for 1080ti/1070/10603G "-i 31,31" #
#    "sib"          = "" # my best values Values for 1080ti/1070/10603G "-i 21"
#    "skein"        = "" # my best values Values for 1080ti/1070/10603G "-i 30,29,29" # Beaten by CcminerKlaust-815-CUDA9
#    "skunk"        = "" # my best values Values for 1080ti/1070/10603G "-i 25.7,25.2,25,2" # Fastest
...
#    "x11"          = "" # my best values Values for 1080ti/1070/10603G "-i 21" # beaten by CcminerPalgin
#    "x11evo"       = "" # my best values Values for 1080ti/1070/10603G "-i 21" 
#    "x13"          = ""
#    "x14"          = "" # my best values Values for 1080ti/1070/10603G "-i 21"
#    "x15"          = "" # my best values Values for 1080ti/1070/10603G "-i 20"
#    "x17"          = "" # my best values Values for 1080ti/1070/10603G "-i 21" # same as CcminerPalgin-nist5, but no stratum connection issues, fastest
}
