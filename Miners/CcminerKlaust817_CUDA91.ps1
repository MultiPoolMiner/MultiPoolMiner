...
$Commands = [PSCustomObject]@{
    ...
    "_c11"		= "" # my best values Values for 1080ti/1070/10603G "-i 22,22,22" #C11 beaten by CcminerAlexis78hsr 
    "groestl"	= "" # my best values Values for 1080ti/1070/10603G "-i 26,25,25" #Groestl, fastest
    "_keccak"	= "" # my best values Values for 1080ti/1070/10603G "-i 31,30,29.5" #Keccak
    ...
    "_neoscrypt"	= "" # my best values Values for 1080ti/1070/10603G "-i 21,16,16" #NeoScrypt, beaten by PalginNeoscrypt
    "_nist5"	    = "" # my best values Values for 1080ti/1070/10603G "-i 26,26,25" #Nist5, beaten by Ccminer-x11gost
    "sia"		= "" #Sia
    "__skein"	    = "" # my best values Values for 1080ti/1070/10603G "-i 30,20,28.9" #Skein, beaten by Ccminer-x11gost
