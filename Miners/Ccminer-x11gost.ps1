...
$Commands = [PSCustomObject]@{
    "blake2s"      = "" # my best values Values for 1080ti/1070/10603G "-i 31,31,31" # fastest, do not use Excavator, high rejects
    "_blakecoin"   = "" # my best values Values for 1080ti/1070/10603G "-i 31,31,31" # beaten by CcminerAlexis78hsr 
    "c11"         = "" # my best values Values for 1080ti/1070/10603G "-i 21" # Beaten by Ccminer-HSR
    #"decred"      = "" # boo
    "_keccak"      = "" # my best values Values for 1080ti/1070/10603G "-i 31,30,29" # Beaten by Excavator138aNvidia4
    "keccakc"      = "" # Keccak-256 (CreativeCoin)
    "_lbry"        = "" # my best values Values for 1080ti/1070/10603G "-i 29,28,28" # Beaten by Excavator138aNvidia4
    "_lyra2v2"     = "" # beaten by CcminerAlexis78Hsr
    "_myr-gr"       = "" # my best values Values for 1080ti/1070/10603G "-i 24,24,24" # Beaten by CcminerKlaust817_CUDA91
    "_neoscrypt"   = "" # my best values Values for 1080ti/1070/10603G "-i 17.1,16.6,15.2" # beaten by CcminerKlaust-817-CUDA91 & PalginHSR_Neoscrypt
    "nist5"       = "" # fastest
    "_nist5"       = "" # my best values Values for 1080ti/1070/10603G "-i 26.75,26.25,24.75" # fastest
    "penta"        = "" # Pentablake hash (5x Blake 512)
    "_phi"          = "" # my best values Values for 1080ti/1070/10603G "-i 25,24,24" # Ccminer 2.2.3 x86 is faster
    "_polytimos"    = "" # my best values Values for 1080ti/1070/10603G "-i 26.25,26.25" # polytimos, beaten by CcminerPolytimos
    "sia"          = "" # my best values Values for 1080ti/1070/10603G "-i 31,31,31" #
    "sib"         = "" # my best values Values for 1080ti/1070/10603G "-i 23,21.4,21" # Fastest
    "_skein"       = "" # my best values Values for 1080ti/1070/10603G "-i 30,29,28.9" # beaten by CcminerSp, dodgy hasrate
    "_tribus"      = ""
    "_vanilla"     = ""
