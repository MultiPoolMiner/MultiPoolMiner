...
$Commands = [PSCustomObject]@{
    "_blake2s"			= @() #Blake2s, beaten bx Excavator 4 treads
    "cryptonight"		= @() #Cryptonight
    "decred"			= @() #Decred
    "daggerhashimoto"	= @() #Ethash
    "_equihash"			= @() #Equihash beaten by DSTM
	"_neoscrypt"		= @() #NeoScrypt, beaten by CcminerKlausT815_CUDA9
    "_keccak"			= @() #Keccak, beaten bx Excavator 4 treads
    "_lbry"				= @() #Lbry, beaten bx Excavator 4 treads
