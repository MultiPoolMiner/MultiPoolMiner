...
$Commands = [PSCustomObject]@{
    ...
    #"ethash"      = "" #Ethash
    #"groestl"     = "" #Groestl
    "hmq1725"      = " -i 21,20,20 -m 2" #HMQ1725
    "jha"          = " -i 24,22,22" #JHA
    #"keccak"      = "" #Keccak
    #"lbry"        = "" #Lbry
    "_lyra2v2"     = " -i 24.25,24.25,22" #Lyra2RE2 beaten by Excavator132Nvidia6
    "_lyra2z"       = " -i 21.5,21,20.5" #Lyra2z, equal to by CcminerLyra2z, 40% of hashes go missing at the pool?
    "_myr-gr"      = " -i 25" #MyriadGroestl beaten by CcminerAlexis78cuda8.0
    "_neoscrypt"   = " -i 24" #NeoScrypt beaten by CcminerKlaust
    #"nist5"       = "" #Nist5
    #"pascal"      = "" #Pascal
    #"scrypt"      = "" #Scrypt
    #"sia"         = "" #Sia
    #"sib"         = "" #Sib
    #"skein"       = "" #Skein
    "_skunk"        = " -i 25,23,23" #Skunk, beaten by Ccminer 2.2.2
