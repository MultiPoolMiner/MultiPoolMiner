...
$Commands = [PSCustomObject]@{
    ...
    "hmq1725"       = ""
    "hsr"           = "" # my best values Values for 1080ti/1070/10603G "-i 21,21,20.25"  #HSR, beaten by CcminerAlexis78hsr
    ...
    "nist5"         = "" # my best values Values for 1080ti/1070/10603G "-i 22" # Beaten, beaten by CcminerKlaust817_CUDA91
    "penta"         = "" # Pentablake hash (5x Blake 512)
    "phi"           = "" # my best values Values for 1080ti/1070/10603G "-i 25,24,24"
    "polytimos"     = "" # my best values Values for 1080ti/1070/10603G "-i 25.5,25.5,25" # polytimos, beaten by CcminerPolytimos
    "sia"           = "" # my best values Values for 1080ti/1070/10603G "-i 31,31,31" #
    "sib"           = "" # my best values Values for 1080ti/1070/10603G "-i 21"
    "skein"         = "" # my best values Values for 1080ti/1070/10603G "-i 30,29,28.9" # beaten by others
