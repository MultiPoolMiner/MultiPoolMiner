...
while ($true) {
    ...
    #Messy...?
    $AllMiners = if (Test-Path "MinersLinux") {
        Get-ChildItemContent "MinersLinux" -Parameters @{Pools = $Pools; Stats = $Stats} | ForEach-Object {$_.Content | Add-Member Name $_.Name -PassThru} | 
