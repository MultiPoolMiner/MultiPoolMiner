...
while (-not $API.Stop) { 
    ...
    if ($Config.IgnorePowerCost) { 
        $BestMiners = @($ActiveMiners | Select-Object DeviceName -Unique | ForEach-Object { $Miner_GPU = $_; ($ActiveMiners | Where-Object { (Compare-Object $Miner_GPU.DeviceName $_.DeviceName | Measure-Object).Count -eq 0 -and $_.Earning -ne 0 } | Sort-Object -Descending { ($_ | Where-Object Speed -contains $null | Measure-Object).Count }, { $_.New }, { $(if ($_.Speed -contains $null) { $_.IntervalMultiplier } else { 0 }) }, { $Config.MeasurePowerUsage -and $_.Earning -ne $null -and $_.PowerUsage -eq $null }, { $_.Earning_Bias }, { $_ | Where-Object Earning -NE 0 }, { $_.IntervalMultiplier } | Select-Object -First 1) })
        $BestMiners_Comparison = @($ActiveMiners | Select-Object DeviceName -Unique | ForEach-Object { $Miner_GPU = $_; ($ActiveMiners | Where-Object { (Compare-Object $Miner_GPU.DeviceName $_.DeviceName | Measure-Object).Count -eq 0 -and $_.Earning -ne 0 } | Sort-Object -Descending { ($_ | Where-Object Speed -contains $null | Measure-Object).Count }, { $_.New }, { $(if ($_.Speed -contains $null) { $_.IntervalMultiplier } else { 0 }) }, { $Config.MeasurePowerUsage -and $_.Earning -ne $null -and $_.PowerUsage -eq $null }, { $_.Earning_Comparison }, { $_ | Where-Object Earning -NE 0 }, { $_.IntervalMultiplier } | Select-Object -First 1) })
    }
    else { 
        $BestMiners = @($ActiveMiners | Select-Object DeviceName -Unique | ForEach-Object { $Miner_GPU = $_; ($ActiveMiners | Where-Object { (Compare-Object $Miner_GPU.DeviceName $_.DeviceName | Measure-Object).Count -eq 0 -and $_.Earning -ne 0 } | Sort-Object -Descending { ($_ | Where-Object Speed -contains $null | Measure-Object).Count }, { $_.New }, { $(if ($_.Speed -contains $null) { $_.IntervalMultiplier } else { 0 }) }, { $Config.MeasurePowerUsage -and $_.Earning -ne $null -and $_.PowerUsage -eq $null }, { $_.Profit_Bias }, { $_ | Where-Object Profit -NE 0 }, { $_.IntervalMultiplier } | Select-Object -First 1) })
        $BestMiners_Comparison = @($ActiveMiners | Select-Object DeviceName -Unique | ForEach-Object { $Miner_GPU = $_; ($ActiveMiners | Where-Object { (Compare-Object $Miner_GPU.DeviceName $_.DeviceName | Measure-Object).Count -eq 0 -and $_.Earning -ne 0 } | Sort-Object -Descending { ($_ | Where-Object Speed -contains $null | Measure-Object).Count }, { $_.New }, { $(if ($_.Speed -contains $null) { $_.IntervalMultiplier } else { 0 }) }, { $Config.MeasurePowerUsage -and $_.Earning -ne $null -and $_.PowerUsage -eq $null }, { $_.Profit_Comparison }, { $_ | Where-Object Profit -NE 0 }, { $_.IntervalMultiplier } | Select-Object -First 1) })
    }
