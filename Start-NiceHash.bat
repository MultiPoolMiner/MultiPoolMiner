...
@set "command=& .\multipoolminer.ps1 -wallet 1Q24z7gHPDbedkaWDTFqhMF8g7iHMehsCb -username aaronsace -workername multipoolminer -region europe -currency btc,usd,eur -DeviceName amd,nvidia,cpu -poolname nicehash -algorithm blake2s,cryptonightv7,decrednicehash,ethash,equihash,keccak,lbry,lyra2re2,neoscrypt,pascal,sib,skunk -donate 24 -watchdog -minerstatusurl https://multipoolminer.io/monitor/miner.php -switchingprevention 2"
