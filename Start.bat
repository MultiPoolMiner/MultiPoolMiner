...
set "command=& .\multipoolminer.ps1 -Wallet 1Q24z7gHPDbedkaWDTFqhMF8g7iHMehsCb -UserName aaronsace -WorkerName multipoolminer -Region europe -Currency btc,usd,eur -DeviceName amd,nvidia,cpu -PoolName miningpoolhub-coin,zpool-algo,nicehash -Algorithm blake2s,cuckarood29,cuckatoo31,cryptonightR,cryptonightV8,cryptonightheavy,decred,ethash,equihash,equihash1445,equihashr15053,keccak,lbry,lyra2re3,mtp,neoscrypt,pascal,sib,skein,skunk,sonoa,timetravel10,x16r,x16rt,x16s,x17,x22i -Donate 24 -Watchdog -MinerStatusURL https://multipoolminer.io/monitor/miner.php -SwitchingPrevention 2"
