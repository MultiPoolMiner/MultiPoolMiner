...
$Path = ".\Bin\CPU-Cryply_v3.8.8.3\cpuminer-avx.exe"
$HashSHA256 = "3311EDE9D31B9746368530BC8F4C3872B7283FBFED435BA52560DB3193ED1DC2"
...
$Devices = $Devices | Where-Object Type -EQ "CPU" | Where-Object {(-not $_.CpuFeatures) -or ($_.CpuFeatures -contains "avx")}
