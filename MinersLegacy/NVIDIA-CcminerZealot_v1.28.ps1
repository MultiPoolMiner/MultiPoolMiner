...
if ($DriverVersion -lt [System.Version]("10.0.0")) {
    $HashSHA256 = "BCA1E943DD5858CCA9605FB20F4ECA3D2DF3F2EB7A303320C256AF565794EF49"
    $Uri = "hhttps://github.com/MultiPoolMiner/miner-binaries/releases/download/Zenemy/z-enemy.1-28-cuda9.2.zip"
}
else {
    $HashSHA256 = "B6616E13ECE982C2C439760F25445BDF1D64A40C4797CDC209021C85D4E9DF84"
