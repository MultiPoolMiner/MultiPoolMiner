...
if (-not $Pools.Equihash.SSL) {
    $Devices | Select-Object Model -Unique | ForEach-Object {
        ...
        [PSCustomObject]@{
            ...
            Arguments        = "--eexit 1 --api 127.0.0.1:$Miner_Port --server $($Pools.Equihash.Host) --port $($Pools.Equihash.Port) --user $($Pools.Equihash.User) --pass $($Pools.Equihash.Pass) --intensity 64 --cuda_devices $(($Miner_Device | ForEach-Object {'{0:x}' -f ($_.Type_Vendor_Index)}) -join ' ')"
