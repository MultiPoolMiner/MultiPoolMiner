...
$HashSHA256 = "CD626E60C9C7A2B08B734C3241384AD2D69AE65A465D7D82064E95F14611F069"
$Uri = "https://github.com/andru-kun/wildrig-multi/releases/download/0.15.0/wildrig-multi-windows-0.15.0.12-beta.7z"
...
$CommandsBaffin = [PSCustomObject]@{
    ...
    "lyra2v3"     = " --opencl-threads 1 --opencl-launch 21x0" # new with 14.0 beta
    "lyra2vc0ban" = " --opencl-threads 1 --opencl-launch 21x0" # new with 0.13.6.2 beta
    "nist5"       = " --opencl-threads 2 --opencl-launch 18x128"
    "mtp"         = " --opencl-threads 1 --opencl-launch 16x0" # new with 15.0.2 beta
    ...
    "x16rt"       = " --opencl-threads 2 --opencl-launch 20x0" # new with 15.0.8 beta
...
$CommandsEllesmere32CU = [PSCustomObject]@{
    ...
    "hmq1725"     = " --opencl-threads 2 --opencl-launch 20x128"
    "lyra2v3"     = " --opencl-threads 1 --opencl-launch 23x0" # new with 14.0 beta
...
# "glt-astralhash" = "" # new with 14.0; no parameters available yet
# "glt-jeonghash" = "" # new with 14.0; no parameters available yet
# "glt-padihash" = "" # new with 14.0; no parameters available yet
# "glt-pawelhash" = "" # new with 14.0; no parameters available yet
    ...
    $Commands | Get-Member -MemberType NoteProperty | Select-Object -ExpandProperty Name | Where-Object {$Pools.(Get-Algorithm $_).Protocol -eq "stratum+tcp" <#temp fix#>} | ForEach-Object {
        ...
        if ($Pools.$Algorithm_Norm.Host -and $Miner_Device) {
            ...
            [PSCustomObject]@{
                ...
                Port               = $Miner_Port
                URI                = $Uri
                Fees               = $(if ($Algorithm_Norm -eq "Mtp") {[PSCustomObject]@{$Algorithm_Norm = 2 / 100}} else {[PSCustomObject]@{$Algorithm_Norm = 1 / 100}})
