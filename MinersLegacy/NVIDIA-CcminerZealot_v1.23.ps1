...
$Uri = "https://github.com/MultiPoolMiner/miner-binaries/releases/download/Zenemy/z-enemy.1-23-cuda9.2_x64.zip"
    ...
    $HashSHA256 = "8966B3AE0AB2758D30CB76F5A94F44E51F95BEA542CE4FA709CA376686271959"
    $Uri = "https://github.com/MultiPoolMiner/miner-binaries/releases/download/Zenemy/z-enemy.1-23-cuda10.0_x64.zip"
}
