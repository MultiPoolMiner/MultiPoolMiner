...
if ($DriverVersion -lt [System.Version]("10.0.0")) {
    ...
    $HashSHA256 = "FB827C700F6D2C88E91CCC151EA42E5596A413D4296348294C8B9B0541D4147B"
}
else {
    $Uri = "https://github.com/technobyl/CryptoDredge/releases/download/v0.13.0/CryptoDredge_0.13.0_cuda_10.0_windows.zip"
    $HashSHA256 = "8581E83B1EBC2CBCB7DE066BB2888B50FDBDD5E45FCB7AC75E0CA018789CEB84"
}
