...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{Algorithm = "bittubev2";   MinMemGb = 2; Command = ""; Intensity = @(); DoubleThreads = $true} # CryptonightDark 
    ...
    [PSCustomObject]@{Algorithm = "hospital";    MinMemGb = 2; Command = ""; Intensity = @(); DoubleThreads = $true} # Cryptonight???
    [PSCustomObject]@{Algorithm = "hycon";       MinMemGb = 2; Command = ""; Intensity = @(); DoubleThreads = $true} # Cryptonight???, new in 1.7.3
    ...
    [PSCustomObject]@{Algorithm = "normalv4";    MinMemGb = 1; Command = ""; Intensity = @(); DoubleThreads = $true} # CryptonightV4
    [PSCustomObject]@{Algorithm = "normalv7";    MinMemGb = 1; Command = ""; Intensity = @(); DoubleThreads = $true} # CryptonightV7
    [PSCustomObject]@{Algorithm = "normalv8";    MinMemGb = 1; Command = ""; Intensity = @(); DoubleThreads = $true} # CryptonightV8, new in 1.6.8
    [PSCustomObject]@{Algorithm = "stellitev8";  MinMemGb = 1; Command = ""; Intensity = @(); DoubleThreads = $true} # Cryptonight???, new in 1.7.3
    [PSCustomObject]@{Algorithm = "turtle";      MinMemGb = 1; Command = ""; Intensity = @(); DoubleThreads = $true} # Cryptonight???, new in 1.7.4
    [PSCustomObject]@{Algorithm = "upx2";        MinMemGb = 1; Command = ""; Intensity = @(); DoubleThreads = $true} # Cryptonight???, new in 1.8.6
    [PSCustomObject]@{Algorithm = "xcash";       MinMemGb = 1; Command = ""; Intensity = @(); DoubleThreads = $true} # Cryptonight???, new in 1.7.9
    [PSCustomObject]@{Algorithm = "zelerius";    MinMemGb = 1; Command = ""; Intensity = @(); DoubleThreads = $true} # Cryptonight???, new in 1.7.9
