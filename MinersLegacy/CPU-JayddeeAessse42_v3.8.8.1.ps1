...
$Path = ".\Bin\CPU-Jayddee_v3.8.8.1\cpuminer-aes-sse42.exe"
...
$Devices = $Devices | Where-Object Type -EQ "CPU" | Where-Object {(-not $_.CpuFeatures) -or ($_.CpuFeatures -contains "sse4.2" -and $_.CpuFeatures -contains "aes-ni")}
