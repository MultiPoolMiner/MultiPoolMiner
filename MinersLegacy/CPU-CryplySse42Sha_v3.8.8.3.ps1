...
$Path = ".\Bin\CPU-Cryply_v3.8.8.3\cpuminer-sse42-sha.exe"
$HashSHA256 = "90BB0C98B048700D1AA7CE229F37F2F54292379EF1ED2D74BB9324F7E4A6F50B"
...
$Devices = $Devices | Where-Object Type -EQ "CPU" | Where-Object {(-not $_.CpuFeatures) -or ($_.CpuFeatures -contains "sse4.2" -and $_.CpuFeatures -contains "sha")}
