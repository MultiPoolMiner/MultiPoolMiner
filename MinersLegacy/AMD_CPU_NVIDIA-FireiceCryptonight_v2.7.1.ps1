...
$HashSHA256 = "9CF1BBFB52FD491C9D336D61B9D500F2974909617A32B7E0EEAC72E03BE1B697"
...
$Commands = [PSCustomObject[]]@(
    ...
    #       2 thread config does not work with NVIDIA
...
$Devices | Select-Object Vendor, Model -Unique | ForEach-Object {
    ...
    $Commands | Where-Object {$Pools.(Get-Algorithm $_.Algorithm)} | Where-Object {-not ($Device.Vendor -contains "NVIDIA Corporation" -and $_.Threads -eq 2)} | ForEach-Object {
