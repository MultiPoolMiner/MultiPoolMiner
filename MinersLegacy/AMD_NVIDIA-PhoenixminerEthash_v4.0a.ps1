...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "ethash2gb"; MinMemGB = 2; SecondaryAlgorithm = "blake2s"; SecondaryIntensity = 10; Params = ""} #Ethash2gb/Blake2s10
    ...
    [PSCustomObject]@{MainAlgorithm = "ethash3gb"; MinMemGB = 3; SecondaryAlgorithm = "blake2s"; SecondaryIntensity = 10; Params = ""} #Ethash3gb/Blake2s10
    ...
    [PSCustomObject]@{MainAlgorithm = "ethash";    MinMemGB = 4; SecondaryAlgorithm = "blake2s"; SecondaryIntensity = 10; Params = ""} #Ethash/Blake2s10
    ...
    $Commands | Where-Object {$Vendor -eq "AMD" -or -not $_.SecondaryAlgorithm} | ForEach-Object { #Dual mining is only supported for AMD
        ...
        if ($Pools.$Main_Algorithm_Norm.Host -and $Miner_Device) {
            ...
            if ($_.SecondaryAlgorithm) {
                ...
                $Arguments_Secondary = " -dcoin $Secondary_Algorithm -dpool $($Pools.$Secondary_Algorithm_Norm.Host):$($Pools.$Secondary_Algorithm_Norm.Port) -dwal $($Pools.$Secondary_Algorithm_Norm.User) -dpass $($Pools.$Secondary_Algorithm_Norm.Pass)$(if($_.SecondaryIntensity -ge 0){" -sci $($_.SecondaryIntensity)"})"
