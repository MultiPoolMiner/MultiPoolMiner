...
if ($CUDAVersion -lt [System.Version]("10.1.0")) {
    $HashSHA256 = "69E0742CDD0C404E4D5C0A5ACC9969B72F19ACAABE9ECA9F255BAE790B2D733B"
    $Uri = "https://github.com/technobyl/CryptoDredge/releases/download/v0.20.2/CryptoDredge_0.20.2_cuda_9.2_windows.zip"
}
else {
    $HashSHA256 = "8E2BE4940289A683DFF184775A35A32D69B56376455978B001FBB07B1A451362"
