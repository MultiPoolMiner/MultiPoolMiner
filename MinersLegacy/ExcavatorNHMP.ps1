...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{Algorithm = "equihash"; Threads = 1; MinMemGb = 2; Params = @()} #Equihash
    [PSCustomObject]@{Algorithm = "lbry"; Threads = 1; MinMemGb = 2; Params = @()} #Lbry
    [PSCustomObject]@{Algorithm = "lyra2rev2"; Threads = 1; MinMemGb = 1; Params = @()} #Lyra2RE2
    [PSCustomObject]@{Algorithm = "lyra2z"; Threads = 1; MinMemGb = 1; Params = @()} #Lyra2z
    [PSCustomObject]@{Algorithm = "neoscrypt"; Threads = 1; MinMemGb = 2; Params = @()} #NeoScrypt
    ...
    [PSCustomObject]@{Algorithm = "equihash"; Threads = 2; MinMemGb = 2*2; Params = @()} #Equihash
    [PSCustomObject]@{Algorithm = "lbry"; Threads = 2; MinMemGb = 2*2; Params = @()} #Lbry
    [PSCustomObject]@{Algorithm = "lyra2rev2"; Threads = 2; MinMemGb = 2*1; Params = @()} #Lyra2RE2
    [PSCustomObject]@{Algorithm = "lyra2z"; Threads = 2; MinMemGb = 2*1; Params = @()} #Lyra2z
    #[PSCustomObject]@{Algorithm = "neoscrypt"; Threads = 2; MinMemGb = 2*2; Params = @()} #NeoScrypt 2 threads crashes
    [PSCustomObject]@{Algorithm = "daggerhashimoto_decred"; Threads = 2; MinMemGb = 2*4; Params = @()} #Dual mining 2 threads
    [PSCustomObject]@{Algorithm = "daggerhashimoto_pascal"; Threads = 2; MinMemGb = 2*4; Params = @()} #Dual mining 2 threads
    [PSCustomObject]@{Algorithm = "daggerhashimoto_sia"; Threads = 2; MinMemGb = 2*4; Params = @()} #Dual mining 2 threads
