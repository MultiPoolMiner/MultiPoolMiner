...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{ Algorithm_Norm = "Cryptonight"    ; MinMemGB = 2; Commands = ""     ; } #Cryptonight
)
...
$Devices | Select-Object Model -Unique | ForEach-Object { 
    ...
    $Commands | ForEach-Object { $Algorithm_Norm = @(@(Get-Algorithm ($_.Algorithm -split '-' | Select-Object -First 1) | Select-Object) + @($_.Algorithm -split '-' | Select-Object -Skip 1) | Select-Object -Unique) -join '-'; $_ } | Where-Object { $Pools.$Algorithm_Norm.Protocol -eq "stratum+tcp" } | ForEach-Object { 
        $MinMemGB = $_.MinMemGB
