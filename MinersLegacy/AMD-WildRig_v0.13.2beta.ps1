...
$HashSHA256 = "7AF96270B5B95E69F4203832397D45B309CF3688401C593C1C727FE621FC0106"
$Uri = "https://github.com/MultiPoolMiner/miner-binaries/releases/download/WildRig/wildrig-multi-0.13.2-beta.7z"
...
$Devices | Select-Object Model -Unique | ForEach-Object {
    ...
    if ($Config.CreateMinerInstancePerDeviceModel) {
        Switch (($Miner_Device | Select-Object -First 1 -ExpandProperty OpenCl).Name) {
            "Baffin" {$Commands = $CommandsBaffin}
