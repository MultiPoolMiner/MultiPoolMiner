...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{Algorithm = "freehaven";  Threads = 1; MinMemGb = 1; Params = ""; Intensity = @()} # CryptonightFreeHaven 1 thread
    ...
    [PSCustomObject]@{Algorithm = "freehaven";  Threads = 2; MinMemGb = 1; Params = ""; Intensity = @()} # CryptonightFreeHaven 2 threads
    ...
    [PSCustomObject]@{Algorithm = "mox";        Threads = 2; MinMemGb = 1; Params = ""; Intensity = @()} # CryptonightRed 2 threads
