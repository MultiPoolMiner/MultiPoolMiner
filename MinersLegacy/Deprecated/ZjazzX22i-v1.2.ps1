...
$Devices = @($Devices | Where-Object Type -EQ "GPU" | Where-Object Vendor -EQ "AMD" | Where-Object { $_.OpenCL.GlobalMemsize -ge 2GB } | Where-Object { $_.Model -match "^Baffin.*|^Ellesmere.*|^Fiji.*|^gfx900.*|^Tonga.*" })
