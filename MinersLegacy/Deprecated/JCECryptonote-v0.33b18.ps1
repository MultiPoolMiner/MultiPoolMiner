...
$Commands = [PSCustomObject[]]@(
    #[PSCustomObject]@{ Algorithm = "Cryptonight"          ; MinMemGB = 2; Command = " --variation 1" ; } #Original Cryptonight
    #[PSCustomObject]@{ Algorithm = "Cryptolight"          ; MinMemGB = 1; Command = " --variation 2" ; } #Original Cryptolight
