...
$HashSHA256 = "618640C183CF893C8E9C5BD7824A2EAE1AB81A1D8EFC6717F1A6602F65AF3C5D"
$Uri = "https://github.com/MultiPoolMiner/miner-binaries/releases/download/SRBMiner/SRBMiner-CN-V1-7-0.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{Algorithm = "bittubev2";  Threads = 1; MinMemGb = 2; Params = ""; Intensity = @()} # CryptonightHeavyTube 1 thread
