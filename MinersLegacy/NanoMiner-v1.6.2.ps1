...
$Commands = [PSCustomObject[]]@(
    #[PSCustomObject]@{ Algorithm = "Ethash"                 ; MinMemGB = 4; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #Ethash, other Ethash miners are faster
    #[PSCustomObject]@{ Algorithm = "Ethash-2gb"             ; MinMemGB = 2; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #Ethash2GB, other Ethash miners are faster
    #[PSCustomObject]@{ Algorithm = "Ethash-3gb"             ; MinMemGB = 3; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #Ethash3GB, other Ethash miners are faster
    #[PSCustomObject]@{ Algorithm = "Ethash-4gb"             ; MinMemGB = 4; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #Ethash4GB, other Ethash miners are faster
    [PSCustomObject]@{ Algorithm = "Ubqhash"                ; MinMemGB = 4; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #Ubqhash
    [PSCustomObject]@{ Algorithm = "CryptoNight"            ; MinMemGB = 2; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #Cryptonight
    [PSCustomObject]@{ Algorithm = "CryptoNightR"           ; MinMemGB = 2; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #CryptonightR
    [PSCustomObject]@{ Algorithm = "CryptoNightV7"          ; MinMemGB = 2; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #CryptonightV1
    [PSCustomObject]@{ Algorithm = "CryptoNightV8"          ; MinMemGB = 2; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #CryptonightV2
    [PSCustomObject]@{ Algorithm = "CryptoNightReverseWaltz"; MinMemGB = 2; Vendor = @("AMD", "NVIDIA")       ; Fee = 1; Command = "" } #CryptonightRwz
    [PSCustomObject]@{ Algorithm = "Cuckaroo29"             ; MinMemGB = 6; Vendor = @("AMD", "NVIDIA")       ; Fee = 2; Command = "" } #Cuckaroo29
    [PSCustomObject]@{ Algorithm = "Cuckarood29"            ; MinMemGB = 6; Vendor = @("AMD", "NVIDIA")       ; Fee = 2; Command = "" } #Cuckarood29, new with 1.5.0
    [PSCustomObject]@{ Algorithm = "RandomHash"             ; MinMemGB = 2; Vendor = @("CPU")                 ; Fee = 5; Command = "" } #RandomHash, CPU only
    [PSCustomObject]@{ Algorithm = "RandomHash2"            ; MinMemGB = 2; Vendor = @("AMD", "CPU")          ; Fee = 5; Command = "" } #RandomHash2, new with 1.6.0
    [PSCustomObject]@{ Algorithm = "RandomX"                ; MinMemGB = 0; Vendor = @("CPU")                 ; Fee = 5; Command = "" } #RandomX, new with 1.6.0
)
