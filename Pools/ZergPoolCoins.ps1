...
$ZergPoolCoins_MiningCurrencies | Where-Object {$DisabledCoin -inotcontains $ZergPoolCoins_Request.$_.name -and $DisabledAlgorithm -inotcontains (Get-Algorithm $ZergPoolCoins_Request.$_.algo) -and ($Coins.count -eq 0 -or $Coins -icontains $ZergPoolCoins_Request.$_.name) -and $ZergPoolCoins_Request.$_.hashrate -gt 0} | ForEach-Object {
