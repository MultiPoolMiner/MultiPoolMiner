...
$ZpoolCoins_Request | Get-Member -MemberType NoteProperty -ErrorAction Ignore | Select -ExpandProperty Name | Where {$ZpoolCoins_Request.$_.algo} | Where-Object {$ZpoolCoins_Request.$_.hashrate -gt 0} | ForEach {
