...
$MiningPoolHub_Request.return | Where-Object {$DisabledCoins -inotcontains $_.current_mining_coin -and $DisabledAlgorithms -inotcontains (Get-Algorithm $_.algo)} | ForEach-Object {
