...
- **Supports benchmarking, multiple platforms (NVIDIA and CPU, AMD is currently under development) and mining on MiningPoolHub, Zpool, Hash Refinery and Nicehash & Ahashpool**
...
1. Download the latest code version (.zip package) from https://github.com/UselessGuru/MultiPoolMiner/archive/master.zip
...
###### A2. Use the Setup GUI to change the $excludeminername parameter in 'Config.ps1' to exclude certain miners you don't want to use. A full list of available miners and parameters used can be found here: https://multipoolminer.io/miners
