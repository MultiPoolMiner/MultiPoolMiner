...
@set "command=& .\multipoolminer.ps1 -wallet 1Q24z7gHPDbedkaWDTFqhMF8g7iHMehsCb -username aaronsace -workername multipoolminer -region europe -currency btc,usd,eur -type amd -donate 24 -watchdog -minerstatusurl https://multipoolminer.io/monitor/miner.php -switchingprevention 2 -excludealgorithm sha256,blake256,blakevanilla,decred,decrednicehash,sia,pascal,lbry,scrypt,x11,x13,x14,x15,quark,qubit,sib,nist5,myriadgroestl,blakecoin,cryptonight"
