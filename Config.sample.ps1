...
# If $true separate miners will be launched for each GPU model class, this will further help to increase profit. Note: This is an experimental feature!
